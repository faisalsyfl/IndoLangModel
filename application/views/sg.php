	  				...
	  				<div class="panel-body">
	  					<div class="row">
	  						<div class="col-md-12">
			  					<div class="panel panel-info">
					  				<div class="panel-heading">
					    				<h3 class="panel-title">Generated Sentence</h3>
								  	</div>
								  	<div class="panel-body">
								  		<table class="table table-condensed">
					  						<tbody>
					  							<?php if(isset($visual)){ ?>
					  							<tr class="warning">
					  								<td style="color:green;">START</td>
					  								<?php foreach($visual['0'] as $word){ ?>
					  								<td><?php echo $word; ?></td>
					  								<?php } ?>
					  							...
					  							<tr class="warning">
					  								<td style="color:green;">START</td>
					  								<?php foreach($visual['1'] as $word){ ?>
					  								<td><?php echo number_format($word,2); ?></td>
					  								<?php } ?>
					  								<td style="color:red;">END</td>
					  							</tr>					  							
					  							<?php }else{ ?>
