	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				<a style="padding-top: 10px; color:white;" class="navbar-brand" href="<?php echo site_url(); ?>">&nbsp;&nbsp;<span><img src="<?php echo base_url(); ?>assets/img/h.png" width="5%">&nbsp;&nbsp;</span>Indonesian Language Model</a>
			</div>
			...
			<div class="col-md-7">
				<div class="panel panel-primary">
	  				...
	  				<div class="panel-body">
	  					...
	  					<h4>Probability Checker</h4>
							<div class="form-group">
								<div class="col-md-6">
									<input type="text" class="form-control" placeholder="First Word" name="first" required="">		
								</div>
								<div class="col-md-6">
									<input type="text" class="form-control" placeholder="Second Word" name="second" required="">
								</div>
						  </div>
						 ...
						 <?php echo form_open('Home/sentenceGeneration'); ?>
	  					<h4>Sentence Generation given first word (Shannon Visualization)</h4>
							<div class="form-group">
								<div class="col-md-6">
